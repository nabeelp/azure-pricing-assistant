...
class TestParallelBOMExecution:
    ...
    async def test_bom_update_runs_in_background(
        ...
        with patch("src.core.orchestrator.create_question_agent") as mock_create:
            ...
            with patch("src.core.orchestrator.run_incremental_bom_update") as mock_bom_update:
                ...
                with patch("src.core.orchestrator.should_trigger_bom_update") as mock_trigger:
    ...
    @pytest.mark.asyncio
    async def test_background_task_clears_reference_on_completion(self, mock_client, session_store):
    ...
    @pytest.mark.asyncio
    async def test_background_task_handles_errors_gracefully(self, mock_client, session_store):
